...
def project_py(score_threshold):
    ...
    if overall_score > score_threshold:
        ...
        best_shift_table.to_excel('../情境3班表/新班表_黑白.xlsx')
        best_meeting_percentage.to_excel('../情境3班表/各組開會出席率.xlsx')
        best_meeting_time.to_excel('../情境3班表/各組開會時間.xlsx')
        best_meeting_act.to_excel('../情境3班表/各組開會出席人數.xlsx')
